                      ...
                      <div class="customer-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                          <img
                            ...
                            src="<?= base_url('dashboard/assets/img/avatars/15.png') ?>"
                            height="110"
                            width="110"
                            alt="User avatar" />
                          <div class="customer-info text-center">
                            <h4 id="customer_name" class="mb-1"></h4>
                            <small id="customer_id"></small>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex justify-content-around flex-wrap my-4">
                        <div class="d-flex align-items-center gap-2">
                          ...
                          <div class="gap-0 d-flex flex-column">
                            <p class="mb-0 fw-medium" id="customer_total_orders"></p>
                            <small>Orders</small>
                          </div>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                          ...
                          <div class="gap-0 d-flex flex-column">
                            <p class="mb-0 fw-medium" id="customer_total_spent"></p>
                            <small>Spent</small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="info-container">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li class="mb-3">
                            ...
                            <span class="badge bg-label-success" id="customer_status"></span>
                          </li>
                          <li class="mb-3">
                    ...
                    <div class="card-body">
                      <div class="row justify-content-between mb-3">
                        ...
                        <span class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center mx-auto mx-md-0 mb-2"
                          ><img src="<?= base_url('dashboard/assets/img/illustrations/rocket.png') ?>" class="w-px-75 m-2" alt="3dRocket"
                        /></span>
                      </div>
                      <button
                        ...
                        <div class="card-body">
                          ...
                          <div class="card-info">
                            ...
                            <div class="d-flex align-items-baseline mb-1 gap-1">
                              <h4 class="text-primary mb-0" id="customer_wallet_balance"></h4>
                      ...
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="card-info">
                            ...
                            <span class="badge bg-label-warning mb-2" id="customer_membership_tier"></span>
                            <p class="text-muted mb-0" id="customer_cashback_percent"></p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <?= $this->section('scripts') ?>
              <script src="<?= base_url('dashboard/assets/js/app-ecommerce-customer-detail.js') ?>"></script>
              <script src="<?= base_url('dashboard/assets/js/app-ecommerce-customer-detail-overview.js') ?>"></script>
          <?= $this->endSection() ?>